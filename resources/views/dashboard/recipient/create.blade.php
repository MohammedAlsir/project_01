...
@section('main_title','إضافة متدرب جديد')
@section('recipient','active')
@section('recipient.create','active')
        ...
        <div class="tab-pane active" id="tab_0">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>إضافة متدرب جديد
                    </div>
                </div>
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="POST" action="{{route('recipient.store')}}" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @csrf
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input required type="text" name="name" class="form-control input-circle" placeholder="اسم المتدرب">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input required type="number"  name="phone" class="form-control input-circle" placeholder="رقم الهاتف">
                                </div>
                            </div>
